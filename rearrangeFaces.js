...
var directoryJSON = "/Users/brennan/Dropbox (HoopSwagg)/Personal/archives/downloads dump/03-22-2021/render-tool-update/render_templates/customized";
...
fs.readdir(directoryJSON, function (err, items) {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    var isJSON = false;
    if (items[i].indexOf("FA-TI-1000-NA-BG-3.json") > -1) {
      isJSON = true;
    }
    if (isJSON == false) {
      continue;
